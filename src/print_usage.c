...
void print_animations_descriptions(void)
{
    char const *descriptions[] = {
        RAINBOW_RAIN_DESCRIPTION, BLIZZARD_DESCRIPTION,
        BOUNCING_BALL_DESCRIPTION, CIRCUS_CIRCLES_DESCRIPTION,
        BUILDING_WINDOWS_DESCRIPTION, RGB_TAN_DESCRIPTION,
        RANDOM_NUMBERS_DESCRIPTION, DIGITAL_CLOCK_DESCRIPTION,
        ZEBRA_HORIZON_DESCRIPTION, TEN_PRINT_DESCRIPTION,
        LASER_DESCRIPTION, HAMON_DESCRIPTION,
        LORENZ_ATTRACTOR_DESCRIPTION, BUBBLE_SORT_VISUALIZER_DESCRIPTION,
        FLOWERS_DESCRIPTION,
        NULL};
